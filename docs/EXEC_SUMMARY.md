[EXEC_SUMMARY_observability.md](https://github.com/user-attachments/files/22052458/EXEC_SUMMARY_observability.md)
...
- Pipeline SLO dashboards (freshness, failure rate, MTTR)
